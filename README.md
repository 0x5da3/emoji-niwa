...
- **GIF export** — the “📸” button (below 🔈) opens a small panel where you choose the **scale** (keep zoom / as on screen / whole garden) plus a zoom fine-tune slider, then records a ~3-second square clip (no UI in the frame) and exports it as a self-encoded GIF, via the share sheet or a download. On iOS you can then turn it into a Live Photo with an Apple Shortcut / compatible app (done on-device — browsers can't create Live Photos directly)

...
- **地形の自動生成** — 5カテゴリ20プリセット（みどり／山・雪／乾燥・岩／水辺／人の場所。例: 草原・森・アマゾン・雪山・火山・峡谷・環礁・滝・都市）を Perlin ノイズで生成、単色塗りつぶし、ランダム散布
...
- **共有リンク** — 左の縦ボタン列の「🔗」で自分のワールドを共有リンク化（静的スナップショット・サーバー不要）。開いた人は閲覧モードで、その人の箱庭やオートセーブには干渉しません（「自分の箱庭に戻る」「これを自分のものに」も可能）。下の「マルチプレイ」とは別物で、こちらは一方向のスナップショット（リアルタイム共同編集ではない）
